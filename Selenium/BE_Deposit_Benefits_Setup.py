...
class BE_Deposit_Benefits_Setup():
    def Benefits_Setup(self):
        ...
        ExistNumber=self.browser.find_element(By.XPATH,value='//tfoot/tr/td/div[1]/div/span').text
        if ExistNumber!=0:
            ErrorMsg='已有'+ExistNumber+'條存款優惠'
            self.browser.quit()
...
if __name__=='__main__':
    BE_Deposit_Benefits_Setup().Benefits_Setup()
=======
#coding=utf-8
from selenium import webdriver
import time
